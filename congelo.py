...
st.markdown("""
    ...
    .main-title { font-size: 2.2rem !important; font-weight: bold; padding-bottom: 1rem; }
...
# On garde les données en mémoire pendant 5 minutes pour accélérer la navigation
        ...
        with st.form("ajout", clear_on_submit=True):
            ...
            if st.form_submit_button("Ajouter"):
                ...
                if res.data: 
                    ...
                    st.cache_data.clear() # On vide le cache pour voir le nouveau produit
                st.rerun()
